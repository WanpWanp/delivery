    ...
    if(isset($_GET['id']) && isset($_GET['image_name'])) {
        ...
        if($image_name != "") {
            ...
            if($remove ==  false) {
                ...
                $_SESSION['remove-food'] = "<div class='error'>Falha ao remover imagem do prato</div>";
        ...
        if($res == true) {
            ...
            $_SESSION['delete-food'] = "<div class='success'>Prato deletado com sucesso</div>";

            header("Location:" . SITE_URL . "admin/manage-food.php");
        } else {
            //Setar a mensagem de erro
            $_SESSION['delete-food'] = "<div class='error'>Falha ao deletar prato</div>";
